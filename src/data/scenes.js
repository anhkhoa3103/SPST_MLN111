...
export const SCENES = [
...

  {
    ...
    lines: [
      ...
      "Tiệm thuốc nằm trong một con dốc nhỏ, bảng hiệu cũ, mùi thảo dược khô bám đầy trên kệ gỗ.",
      ...
      "Phát thấy vậy cũng lấy một lọ. Duy thì không mua gì cả.",
...

  {
    ...
    lines: [
      ...
      "Trọng im lặng và không nói gì cả, có vẻ anh đã giấu một bí mật nào đó.",
...

  {
    ...
    lines: [
      "Điều tra viên nhìn bảng vật chứng.",
      "Mọi thứ đều có lý giải.",
      "Mọi lý giải đều có lỗ hổng.",
      "Anh ta gạch dưới một dòng trong hồ sơ:",
      "\"Không ai nói dối hoàn toàn. Không ai nói thật hoàn toàn.\"",
      "Trên bìa hồ sơ, anh ghi một dòng:",
...

  {
    ...
    breakLines: [
      "Bạn đã đổi ý {X} lần.",
      "Mỗi lần bạn có một lý do khác.",
      "Mỗi lần lý do đó cảm thấy đủ.",
      "Nhưng chỉ có sự thật là không thay đổi.a",
      "Nó đứng yên ở đó - chờ bạn nhìn đúng hướng.",
      "Bạn đã nhìn đúng hướng chưa?",
    ],
  },
